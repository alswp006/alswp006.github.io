---
layout: post
title: "[AI Harness #3] LLM API 비용을 20배 줄인 방법 — 적응형 모델 선택, TRUST-5 품질 체계"
...
categories:
    - project
    - ai-factory
tags: [AI 하네스, LLM 비용 최적화, Claude Code, Haiku, Sonnet, Opus]
series: AI Harness
comments: true
published: true
list: true
