...
flowchart LR
    ...
    Spec --> Template["Template Repo"]
    Template --> Coding["Coding\n적응형 모델"]
    Coding --> Fix["fixLoop"] --> Replan["Re-planning"]
    Replan --> Trust["TRUST-5"] --> Verify["Verification"]
    Verify --> Deploy["Deploy"] --> Hotfix["Hotfix"]
```
