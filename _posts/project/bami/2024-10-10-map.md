---
layout: post
title: "추천 여행지 경로 최적화: 문제 분석과 접근 방법"
...
categories:
    ...
    - spring
    - study
description: AI 추천 여행지의 경로가 최적화되지 않은 문제를 분석합니다. Google Distance Matrix API로 노드 간 거리를 계산하고, API 호출 횟수와 비용 문제를 파악하여 해결 방향을 제시합니다.
tags: [경로 최적화, Google API, 여행 추천, Spring, 알고리즘]
comments: true
published: true
list: true
order: 6
